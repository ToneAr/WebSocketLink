...
public class WebSocketTLS {
	...
	public static KeyStore loadPEMKeyStore(String pemContent) throws Exception {
		...
		if (certBytes == null)
			throw new Exception("No CERTIFICATE block in PEM");
		if (keyBytes == null)
			throw new Exception("No PRIVATE KEY block in PEM");
	...
	public static int getServerSocketPort(ServerSocket ss) {
	...
	static final class TrustAllCerts implements X509TrustManager {
